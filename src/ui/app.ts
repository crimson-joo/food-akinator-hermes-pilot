...
const answerReaction: Record<AnswerKey, { sentiment: string; motion: string; expression: string; copy: string }> = {
...
const animationNames = ['idle-breath', 'blink-gaze', 'spoon-point', 'approve-nod', 'maybe-tilt', 'puzzled-shrug', 'narrow-away', 'prune-swipe', 'thinking-scan', 'confidence-rise', 'oops-recoil', 'recovery-reset', 'lid-reveal'];
const expressionNames = ['warm-blink', 'curious-focus', 'focused-smile', 'soft-smile', 'maybe-smirk', 'puzzled-open', 'skeptical-narrow', 'decisive-prune', 'narrow-thinking', 'spark-confidence', 'oops-open', 'calm-detective', 'bright-payoff'];
