...
const cueContract: Record<string, { silhouette: string; expression: string; propMotion: string; stageTone: string }> = {
...
function renderOracleHost(cue: string, contract: { silhouette: string; expression: string; propMotion: string; stageTone: string }): string {
  return `<div class="oracle-host" aria-hidden="true" data-character-cue="${cue}" data-silhouette="${contract.silhouette}" data-expression="${contract.expression}" data-prop-motion="${contract.propMotion}" data-stage-tone="${contract.stageTone}">
    ...
    <span class="oracle-arm spoon-arm"><span class="oracle-spoon"></span></span>
    <span class="oracle-arm note-arm"><span class="oracle-note-card"><span class="note-line first"></span><span class="note-line second"></span><span class="note-ink">✓</span></span></span>
