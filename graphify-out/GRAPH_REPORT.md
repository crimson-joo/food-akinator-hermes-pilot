...
## Corpus Check
- 55 files · ~305,039 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 806 nodes · 1063 edges · 49 communities (48 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2e94ac03`
...
9. `Character Art/Rig Plan — Akinator-level Benchmark Without Copying` - 12 edges
10. `Food Akinator — 입맛 탐정 보글` - 11 edges
...
Cohesion: 0.06
Nodes (52): CharacterAssetManifest, cueLabel, canRenderLottieRuntime(), CharacterLottieRenderer, CharacterRuntimeAdapter, CharacterRuntimeAssetLoader, CharacterRuntimeSelectionOptions, CharacterRuntimeStatus (+44 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (41): LottieAsset, LottieLayer, LottieMarker, LottieRuntimeManifest, LottieShape, markerByCue, requiredLottieLayers, AnimationClip (+33 more)
...
Cohesion: 0.04
Nodes (48): 현재 상태, 제품 원칙, 실행, 검증, 문서, code:bash (npm install), code:bash (npm test), code:bash (npm test -- --run tests/ui-app.test.ts tests/character-asset) (+40 more)
...
Cohesion: 0.15
Nodes (18): ANSWER_VALUES, AnswerValue, asRecord(), LEVELS, QUESTION_AXES, QUESTION_ROLES, QuestionAxis, QuestionId (+10 more)
...
Cohesion: 0.15
Nodes (14): startSession(), submitAnswer(), dataset, exactHits, failedSummary, paths, representativeCandidateIds, results (+6 more)
...
Cohesion: 0.17
Nodes (11): QuestionRole, submitGuessFeedback(), goldenCandidates, goldenDataset, goldenQuestions, GoldenScenario, goldenScenarios, answerCurrent() (+3 more)
...
Cohesion: 0.23
Nodes (8): foodCandidates, foodKnowledgeBase, foodQuestions, Question, coveredAttributes, questionIds, roles, values
...
Cohesion: 0.4
Nodes (4): useExistingServer, useExistingServer, useExistingServer, useExistingServer

### Community 46 - "Community 46"
Cohesion: 0.4
Nodes (4): isExplicitHermesRun, isExplicitHermesRun, isExplicitHermesRun, isExplicitHermesRun

## Knowledge Gaps
- **487 isolated node(s):** `useExistingServer`, `isExplicitHermesRun`, `runtime`, `html`, `manifest` (+482 more)
...
- **Why does `AnswerKey` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 7`, `Community 9`, `Community 16`, `Community 20`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `Candidate` connect `Community 0` to `Community 3`, `Community 7`, `Community 9`, `Community 16`, `Community 20`, `Community 24`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `작은 음식 도메인 Akinator-like 추론 엔진 + 캐릭터/모션 파이프라인 제안` connect `Community 30` to `Community 33`, `Community 34`, `Community 39`, `Community 40`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 23`, `Community 28`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
