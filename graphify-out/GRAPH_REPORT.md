# Graph Report - feat-simulation-quality-gate  (2026-06-01)

## Corpus Check
- 58 files · ~308,334 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 877 nodes · 1171 edges · 60 communities (59 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `29fdffd0`
...
2. `AnswerKey` - 14 edges
3. `Candidate` - 14 edges
4. `Architect Gate — Food Akinator v0` - 14 edges
5. `작은 음식 도메인 Akinator-like 추론 엔진 + 캐릭터/모션 파이프라인 제안` - 14 edges
6. `selectCharacterRuntime()` - 13 edges
7. `Architecture — Zero-to-One` - 13 edges
8. `Design — Zero-to-One Direction` - 13 edges
...
Cohesion: 0.05
Nodes (46): LottieAsset, LottieLayer, LottieMarker, LottieRuntimeManifest, LottieShape, markerByCue, requiredLottieLayers, AnimationClip (+38 more)
...
Cohesion: 0.1
Nodes (28): SessionDataset, ANSWER_DERIVED_MARKERS, answerForQuestion(), average(), branchEntropy(), calculateSimulationMetrics(), candidateById(), canonicalAnswer() (+20 more)

### Community 5 - "Community 5"
Cohesion: 0.08
Nodes (22): submitAnswer(), afterUnknown, answerCurrent(), answerOptions, asked, asking, candidates, confident (+14 more)

### Community 6 - "Community 6"
Cohesion: 0.1
Nodes (22): startSession(), canonicalTargets, CONTROLLED_DEMO_THRESHOLDS, FULL_LAUNCH_CANDIDATE_THRESHOLDS, RepresentativeSimulationCase, representativeSimulationCases, SimulationAnswerStrategy, canonicalReveals (+14 more)
...
Cohesion: 0.15
Nodes (17): ANSWER_OPTIONS, ANSWER_TRACE_LABEL, answerOptions(), askingSession(), buildAnswerTrace(), BuildInput, buildNextSession(), CharacterCue (+9 more)
...
Cohesion: 0.17
Nodes (12): AnswerKey, QuestionRole, submitGuessFeedback(), goldenCandidates, goldenDataset, goldenQuestions, GoldenScenario, goldenScenarios (+4 more)
...
Cohesion: 0.22
Nodes (8): 1. 목표와 핵심 제품 경험, 13. 회의용 권장 결론, 2. 도메인 데이터 모델, 2.1 Candidate schema: 음식 후보, 2.2 Question bank schema, 작은 음식 도메인 Akinator-like 추론 엔진 + 캐릭터/모션 파이프라인 제안, code:ts (type Candidate = {), code:ts (type Question = {)
...
Cohesion: 0.5
Nodes (4): 5.1 추측 조건, 5.2 Reveal vs tentative guess, 5.3 Confidence messaging, 5. Confidence/reveal threshold

## Knowledge Gaps
- **525 isolated node(s):** `useExistingServer`, `isExplicitHermesRun`, `runtime`, `html`, `manifest` (+520 more)
...
- **Why does `AnswerKey` connect `Community 18` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 11`, `Community 15`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Candidate` connect `Community 27` to `Community 1`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 11`, `Community 15`, `Community 17`, `Community 18`, `Community 49`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `작은 음식 도메인 Akinator-like 추론 엔진 + 캐릭터/모션 파이프라인 제안` connect `Community 38` to `Community 37`, `Community 41`, `Community 42`, `Community 50`, `Community 51`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 28`?**
