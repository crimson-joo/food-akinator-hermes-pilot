...
## Corpus Check
- 55 files · ~302,578 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 752 nodes · 980 edges · 49 communities (48 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7d2ecae6`
...
9. `selectCharacterRuntime()` - 11 edges
...
Cohesion: 0.05
Nodes (57): CharacterAssetManifest, AnimationClip, animationStateMachine, baseTransforms, CharacterConcept, CharacterConceptId, characterConcepts, MotionTimelineStep (+49 more)
...
Cohesion: 0.21
Nodes (14): CandidateScore, scoreCandidates(), FOLLOWUP_ROLES, getActiveCandidates(), getEligibleQuestions(), normalizeWeights(), policyBonus(), QuestionSelection (+6 more)
...
Cohesion: 0.22
Nodes (7): Candidate, AnsweredQuestion, crispyCandidate, probablyScores, scores, soupCandidate, yesScores
...
## Knowledge Gaps
- **459 isolated node(s):** `useExistingServer`, `isExplicitHermesRun`, `runtime`, `html`, `manifest` (+454 more)
...
- **Why does `AnswerKey` connect `Community 0` to `Community 1`, `Community 2`, `Community 7`, `Community 8`, `Community 26`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `Candidate` connect `Community 26` to `Community 1`, `Community 2`, `Community 7`, `Community 8`, `Community 18`, `Community 21`, `Community 22`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `작은 음식 도메인 Akinator-like 추론 엔진 + 캐릭터/모션 파이프라인 제안` connect `Community 30` to `Community 32`, `Community 33`, `Community 39`, `Community 40`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 23`, `Community 27`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
