...
## Corpus Check
- 58 files · ~309,091 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 883 nodes · 1181 edges · 56 communities (55 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ac12f4ac`
...
1. `Food Akinator — 입맛 탐정 보글` - 15 edges
2. `Release — Zero-to-One` - 15 edges
3. `AnswerKey` - 14 edges
4. `Candidate` - 14 edges
5. `Architect Gate — Food Akinator v0` - 14 edges
6. `작은 음식 도메인 Akinator-like 추론 엔진 + 캐릭터/모션 파이프라인 제안` - 14 edges
7. `Architecture — Zero-to-One` - 14 edges
8. `selectCharacterRuntime()` - 13 edges
9. `Design — Zero-to-One Direction` - 13 edges
...
Cohesion: 0.05
Nodes (51): ANSWER_VALUES, AnsweredQuestion, CandidateScore, scoreCandidates(), FOLLOWUP_ROLES, getActiveCandidates(), getEligibleQuestions(), normalizeWeights() (+43 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (47): LottieAsset, LottieLayer, LottieMarker, LottieRuntimeManifest, LottieShape, markerByCue, requiredLottieLayers, AnimationClip (+39 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (47): foodCandidates, foodKnowledgeBase, foodQuestions, AnswerValue, asRecord(), Candidate, LEVELS, Question (+39 more)

### Community 3 - "Community 3"
Cohesion: 0.07
Nodes (45): events, plan, scheduled, animationNames, answerLabel, answerOrder, answerReaction, cueContract (+37 more)
...
Cohesion: 0.08
Nodes (20): afterUnknown, answerOptions, asked, asking, candidates, confident, coreCandidates, coreQuestions (+12 more)
...
Cohesion: 0.13
Nodes (20): ANSWER_DERIVED_MARKERS, average(), branchEntropy(), calculateSimulationMetrics(), CONTROLLED_DEMO_THRESHOLDS, evaluateThresholds(), formatPercent(), FULL_LAUNCH_CANDIDATE_THRESHOLDS (+12 more)

### Community 9 - "Community 9"
Cohesion: 0.13
Nodes (21): 현재 상태, 목표, 원칙, 제품 원칙, 제품 원칙, 제품 원칙, 실행, 실행 (+13 more)
...
Cohesion: 0.1
Nodes (19): Acceptance criteria for production launch, Architect, Auto-resolved decisions, Autoplan Kanban — Food Akinator Production Completion Loop, Current verdict, Designer, Escalation decisions, Evidence index (+11 more)
...
Cohesion: 0.12
Nodes (16): 원칙, Adaptive selector, Answer semantics, Architecture — Zero-to-One, Builder gate, Candidate schema, Character cue contract, code:ts (type Candidate = {) (+8 more)
...
Cohesion: 0.33
Nodes (8): startSession(), submitAnswer(), submitGuessFeedback(), answerCurrent(), playScenario(), { session, askedQuestionIds }, { session, askedQuestionIds, rejectedFirstGuess, recoveryQuestionId }, answerCurrent()

### Community 34 - "Community 34"
Cohesion: 0.22
Nodes (6): QuestionRole, goldenCandidates, goldenDataset, goldenQuestions, GoldenScenario, goldenScenarios
...
Cohesion: 0.29
Nodes (6): isExplicitHermesRun, isExplicitHermesRun, isExplicitHermesRun, isExplicitHermesRun, isExplicitHermesRun, isExplicitHermesRun

### Community 41 - "Community 41"
Cohesion: 0.29
Nodes (7): answerForQuestion(), candidateById(), canonicalAnswer(), copyFromSession(), detectLeakMarkers(), rankOf(), runSimulationCase()
...
Cohesion: 0.29
Nodes (6): useExistingServer, useExistingServer, useExistingServer, useExistingServer, useExistingServer, useExistingServer
...
## Knowledge Gaps
- **528 isolated node(s):** `useExistingServer`, `isExplicitHermesRun`, `runtime`, `html`, `manifest` (+523 more)
...
- **Why does `AnswerKey` connect `Community 1` to `Community 0`, `Community 33`, `Community 2`, `Community 3`, `Community 34`, `Community 4`, `Community 6`, `Community 8`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `Candidate` connect `Community 2` to `Community 0`, `Community 34`, `Community 3`, `Community 6`, `Community 8`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `작은 음식 도메인 Akinator-like 추론 엔진 + 캐릭터/모션 파이프라인 제안` connect `Community 35` to `Community 37`, `Community 38`, `Community 47`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 23`, `Community 27`?**
