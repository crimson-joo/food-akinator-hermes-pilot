...
## Corpus Check
- 46 files · ~300,073 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 666 nodes · 820 edges · 44 communities (42 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `78a34a01`
...
7. `Character Art/Rig Plan — Akinator-level Benchmark Without Copying` - 12 edges
8. `Designer Gate — Food Akinator Zero-to-One` - 11 edges
9. `QA — Zero-to-One Acceptance` - 11 edges
...
Cohesion: 0.06
Nodes (43): foodCandidates, foodKnowledgeBase, foodQuestions, ANSWER_VALUES, AnswerValue, asRecord(), Candidate, LEVELS (+35 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (42): AnsweredQuestion, CandidateScore, scoreCandidates(), FOLLOWUP_ROLES, getActiveCandidates(), getEligibleQuestions(), normalizeWeights(), policyBonus() (+34 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (45): EngineSession, accepted, afterAnswer, afterThinking, animations, answerKeys, answerLabels, askingSession (+37 more)
...
Cohesion: 0.06
Nodes (34): AnswerKey, QuestionRole, startSession(), submitAnswer(), submitGuessFeedback(), goldenCandidates, goldenDataset, goldenQuestions (+26 more)
...
## Knowledge Gaps
- **425 isolated node(s):** `useExistingServer`, `isExplicitHermesRun`, `answerOptions`, `coreQuestions`, `coreCandidates` (+420 more)
...
- **Why does `작은 음식 도메인 Akinator-like 추론 엔진 + 캐릭터/모션 파이프라인 제안` connect `Community 26` to `Community 35`, `Community 36`, `Community 37`, `Community 38`, `Community 39`, `Community 40`, `Community 21`, `Community 23`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `Question` connect `Community 0` to `Community 1`, `Community 3`, `Community 4`?**
