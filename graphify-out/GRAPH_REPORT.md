...
## Corpus Check
- 37 files · ~26,120 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 517 nodes · 621 edges · 40 communities (38 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `28bf26c9`
...
5. `Design — Zero-to-One Direction` - 12 edges
6. `Designer Gate — Food Akinator Zero-to-One` - 11 edges
...
Cohesion: 0.06
Nodes (44): ANSWER_VALUES, AnsweredQuestion, CandidateScore, scoreCandidates(), FOLLOWUP_ROLES, getActiveCandidates(), getEligibleQuestions(), normalizeWeights() (+36 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (36): AnswerKey, AnswerValue, asRecord(), Candidate, LEVELS, Question, QUESTION_AXES, QUESTION_ROLES (+28 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (36): startSession(), accepted, afterAnswer, afterThinking, animations, answerKeys, answerLabels, askingSession (+28 more)

### Community 3 - "Community 3"
Cohesion: 0.1
Nodes (29): animationNames, answerLabel, answerOrder, answerReaction, cueContract, cueFor(), cueLabel, demoCandidates (+21 more)

### Community 4 - "Community 4"
Cohesion: 0.08
Nodes (21): submitAnswer(), answerCurrent(), answerOptions, asked, asking, candidates, confident, coreCandidates (+13 more)
...
## Knowledge Gaps
- **334 isolated node(s):** `useExistingServer`, `isExplicitHermesRun`, `answerOptions`, `coreQuestions`, `coreCandidates` (+329 more)
...
- **Why does `작은 음식 도메인 Akinator-like 추론 엔진 + 캐릭터/모션 파이프라인 제안` connect `Community 19` to `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 14`, `Community 17`, `Community 22`, `Community 24`, `Community 28`, `Community 29`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `Candidate` connect `Community 1` to `Community 0`, `Community 3`, `Community 4`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `Question` connect `Community 1` to `Community 0`, `Community 3`, `Community 4`?**
