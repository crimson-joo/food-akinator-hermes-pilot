...
## Corpus Check
- 37 files · ~22,480 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 481 nodes · 576 edges · 39 communities (37 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e8d3cb3a`
...
9. `Akinator Direct Play Synthesis — Builder Handoff` - 9 edges
10. `Akinator Direct Play Blocker + Manual Observation Protocol` - 9 edges
...
Cohesion: 0.06
Nodes (42): ANSWER_OPTIONS, answerOptions(), askingSession(), BuildInput, buildNextSession(), CharacterCue, DEFAULT_POLICY, exhausted() (+34 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (39): EngineSession, accepted, afterAnswer, afterThinking, answerKeys, answerLabels, buttonMatches, fakeGuessingSession() (+31 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (34): AnswerKey, Candidate, AnsweredQuestion, CandidateScore, scoreCandidates(), FOLLOWUP_ROLES, getActiveCandidates(), getEligibleQuestions() (+26 more)

### Community 3 - "Community 3"
Cohesion: 0.09
Nodes (25): ANSWER_VALUES, AnswerValue, asRecord(), LEVELS, Question, QUESTION_AXES, QUESTION_ROLES, QuestionAxis (+17 more)
...
Cohesion: 0.2
Nodes (9): 1. 목표와 핵심 제품 경험, 13. 회의용 권장 결론, 6.1 Suppression 데이터, 6.2 Recovery strategy, 6.3 Learning hook, 6. Wrong guess suppression/recovery, 작은 음식 도메인 Akinator-like 추론 엔진 + 캐릭터/모션 파이프라인 제안, code:ts (type SessionState = {) (+1 more)
...
Cohesion: 0.5
Nodes (3): answer(), answerUntilGuess(), forbiddenUserVisibleMarkers
...
## Knowledge Gaps
- **305 isolated node(s):** `useExistingServer`, `isExplicitHermesRun`, `answerOptions`, `coreQuestions`, `coreCandidates` (+300 more)
...
- **Why does `작은 음식 도메인 Akinator-like 추론 엔진 + 캐릭터/모션 파이프라인 제안` connect `Community 14` to `Community 32`, `Community 35`, `Community 10`, `Community 16`, `Community 20`, `Community 21`, `Community 27`, `Community 29`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `Candidate` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `Question` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`?**
