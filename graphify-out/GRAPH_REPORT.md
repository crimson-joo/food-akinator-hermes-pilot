# Graph Report - feat-lottie-authored-asset  (2026-06-01)

## Corpus Check
- 55 files · ~304,819 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 800 nodes · 1054 edges · 49 communities (48 shown, 1 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `99612389`
...
10. `Designer Gate — Food Akinator Zero-to-One` - 11 edges
...
Cohesion: 0.06
Nodes (49): AnswerKey, AnsweredQuestion, CandidateScore, scoreCandidates(), FOLLOWUP_ROLES, getActiveCandidates(), getEligibleQuestions(), normalizeWeights() (+41 more)
...
Cohesion: 0.05
Nodes (44): 현재 상태, 제품 원칙, 실행, 검증, 문서, code:bash (npm install), code:bash (npm test), code:bash (npm test -- --run tests/ui-app.test.ts tests/character-asset) (+36 more)
...
Cohesion: 0.2
Nodes (9): 2026-05-29 — Adaptive selector pilot local PASS, 2026-05-30 — Threshold / golden paths / minimal UI scaffold pilot local PASS, 2026-05-30 — Threshold / golden paths / minimal UI scaffold pilot local progress, 2026-05-31 — Akinator-level canonical knowledge base local PASS, 2026-05-31 — Character/brand interaction slice local PASS, 2026-06-01 — Authored-equivalent Lottie runtime candidate, 2026-06-01 — Bogle motion state machine + production completion autoplan, 2026-06-01 — Public docs aligned with live demo / production-blocked state (+1 more)
...
## Knowledge Gaps
- **486 isolated node(s):** `useExistingServer`, `isExplicitHermesRun`, `runtime`, `html`, `manifest` (+481 more)
...
- **Why does `AnswerKey` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 7`, `Community 9`, `Community 16`, `Community 20`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `Candidate` connect `Community 23` to `Community 0`, `Community 2`, `Community 7`, `Community 9`, `Community 16`, `Community 20`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `작은 음식 도메인 Akinator-like 추론 엔진 + 캐릭터/모션 파이프라인 제안` connect `Community 31` to `Community 33`, `Community 34`, `Community 39`, `Community 40`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 24`, `Community 27`?**
