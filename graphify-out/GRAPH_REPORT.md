...
## Corpus Check
- 37 files · ~24,911 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 507 nodes · 608 edges · 40 communities (38 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f74fcb20`
...
4. `Release — Zero-to-One` - 12 edges
5. `Designer Gate — Food Akinator Zero-to-One` - 11 edges
6. `Design — Zero-to-One Direction` - 11 edges
7. `buildNextSession()` - 10 edges
8. `Candidate` - 10 edges
9. `QA — Zero-to-One Acceptance` - 10 edges
10. `renderApp()` - 9 edges
...
Cohesion: 0.05
Nodes (56): EngineSession, accepted, afterAnswer, afterThinking, answerKeys, answerLabels, askingSession, buttonMatches (+48 more)
...
Cohesion: 0.11
Nodes (28): ANSWER_VALUES, AnswerKey, AnsweredQuestion, CandidateScore, scoreCandidates(), ANSWER_OPTIONS, answerOptions(), askingSession() (+20 more)
...
Cohesion: 0.08
Nodes (20): answerCurrent(), answerOptions, asked, asking, candidates, confident, coreCandidates, coreQuestions (+12 more)
...
Cohesion: 0.12
Nodes (15): 디자인 방향, Canonical character/brand direction — 보글 탐정의 작은 식탁, Character requirement, Current minimal UI scaffold, Design — Zero-to-One Direction, Host identity, Non-copy boundary, Premium Oracle Theater v2 contract (+7 more)
...
Cohesion: 0.15
Nodes (12): 금지, 배포 완료 정의, 배포 완료 정의, 배포 완료 정의, 배포 완료 정의, 배포 완료 정의, 배포 완료 정의, 현재 release 상태 (+4 more)
...
## Knowledge Gaps
- **326 isolated node(s):** `useExistingServer`, `isExplicitHermesRun`, `answerOptions`, `coreQuestions`, `coreCandidates` (+321 more)
...
- **Why does `작은 음식 도메인 Akinator-like 추론 엔진 + 캐릭터/모션 파이프라인 제안` connect `Community 19` to `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 13`, `Community 18`, `Community 21`, `Community 22`, `Community 28`, `Community 29`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Candidate` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 5`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `Question` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 5`?**
