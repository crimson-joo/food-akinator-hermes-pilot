...
## Corpus Check
- 37 files · ~24,232 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 502 nodes · 602 edges · 40 communities (38 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `70f79288`
...
5. `Release — Zero-to-One` - 11 edges
6. `buildNextSession()` - 10 edges
7. `Candidate` - 10 edges
8. `QA — Zero-to-One Acceptance` - 10 edges
9. `Design — Zero-to-One Direction` - 10 edges
10. `Akinator Direct Play Synthesis — Builder Handoff` - 9 edges
...
Cohesion: 0.06
Nodes (45): ANSWER_VALUES, AnswerKey, AnsweredQuestion, CandidateScore, scoreCandidates(), FOLLOWUP_ROLES, getActiveCandidates(), getEligibleQuestions() (+37 more)

### Community 1 - "Community 1"
Cohesion: 0.08
Nodes (30): AnswerValue, asRecord(), Candidate, LEVELS, Question, QUESTION_AXES, QUESTION_ROLES, QuestionAxis (+22 more)

### Community 2 - "Community 2"
Cohesion: 0.08
Nodes (27): startSession(), submitAnswer(), submitGuessFeedback(), answerCurrent(), playScenario(), { session, askedQuestionIds }, { session, askedQuestionIds, rejectedFirstGuess, recoveryQuestionId }, answerCurrent() (+19 more)

### Community 3 - "Community 3"
Cohesion: 0.07
Nodes (30): accepted, afterAnswer, afterThinking, answerKeys, answerLabels, askingSession, buttonMatches, cases (+22 more)

### Community 4 - "Community 4"
Cohesion: 0.13
Nodes (22): answerLabel, answerOrder, cueContract, cueFor(), cueLabel, demoCandidates, demoDataset, demoQuestions (+14 more)
...
Cohesion: 0.13
Nodes (14): 디자인 방향, Canonical character/brand direction — 보글 탐정의 작은 식탁, Character requirement, Current minimal UI scaffold, Design — Zero-to-One Direction, Host identity, Non-copy boundary, QA criteria for this direction (+6 more)
...
Cohesion: 0.17
Nodes (11): 금지, 배포 완료 정의, 배포 완료 정의, 배포 완료 정의, 배포 완료 정의, 배포 완료 정의, 현재 release 상태, Release automation contract (+3 more)
...
Cohesion: 0.33
Nodes (5): 2026-05-29 — Adaptive selector pilot local PASS, 2026-05-30 — Threshold / golden paths / minimal UI scaffold pilot local PASS, 2026-05-30 — Threshold / golden paths / minimal UI scaffold pilot local progress, 2026-05-31 — Character/brand interaction slice local PASS, Changelog
...
## Knowledge Gaps
- **322 isolated node(s):** `useExistingServer`, `isExplicitHermesRun`, `answerOptions`, `coreQuestions`, `coreCandidates` (+317 more)
...
- **Why does `작은 음식 도메인 Akinator-like 추론 엔진 + 캐릭터/모션 파이프라인 제안` connect `Community 19` to `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 13`, `Community 16`, `Community 21`, `Community 22`, `Community 28`, `Community 29`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Candidate` connect `Community 1` to `Community 0`, `Community 2`, `Community 4`?**
