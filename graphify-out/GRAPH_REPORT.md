...
## Summary
- 502 nodes · 602 edges · 31 communities (29 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9a0e439a`
...
Cohesion: 0.05
Nodes (52): ANSWER_VALUES, AnswerValue, asRecord(), Candidate, LEVELS, Question, QUESTION_AXES, QUESTION_ROLES (+44 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (53): EngineSession, accepted, afterAnswer, afterThinking, answerKeys, answerLabels, askingSession, buttonMatches (+45 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (49): AnswerKey, QuestionRole, ANSWER_OPTIONS, answerOptions(), askingSession(), BuildInput, buildNextSession(), CharacterCue (+41 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (46): 1. 목표와 핵심 제품 경험, 10.1 클라이언트, 10.2 서버 또는 로컬 엔진, 10.3 데이터 파일 구조 예, 10. 전체 MVP 아키텍처, 11. 주요 리스크와 대응, 12.1 데이터 검증 테스트, 12.2 추론 엔진 테스트 (+38 more)
...
- **Why does `작은 음식 도메인 Akinator-like 추론 엔진 + 캐릭터/모션 파이프라인 제안` connect `Community 3` to `Community 24`, `Community 14`, `Community 15`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Candidate` connect `Community 0` to `Community 1`, `Community 2`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `Question` connect `Community 0` to `Community 1`, `Community 2`?**
