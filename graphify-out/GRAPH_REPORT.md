...
## Corpus Check
- 37 files · ~24,269 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 503 nodes · 603 edges · 39 communities (37 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `88c3de3b`
...
Cohesion: 0.06
Nodes (50): ANSWER_VALUES, Candidate, AnsweredQuestion, CandidateScore, scoreCandidates(), FOLLOWUP_ROLES, getActiveCandidates(), getEligibleQuestions() (+42 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (53): startSession(), accepted, afterAnswer, afterThinking, answerKeys, answerLabels, askingSession, buttonMatches (+45 more)

### Community 2 - "Community 2"
Cohesion: 0.08
Nodes (30): AnswerKey, AnswerValue, asRecord(), LEVELS, Question, QUESTION_AXES, QUESTION_ROLES, QuestionAxis (+22 more)
...
## Knowledge Gaps
- **323 isolated node(s):** `useExistingServer`, `isExplicitHermesRun`, `answerOptions`, `coreQuestions`, `coreCandidates` (+318 more)
...
- **Why does `작은 음식 도메인 Akinator-like 추론 엔진 + 캐릭터/모션 파이프라인 제안` connect `Community 18` to `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 12`, `Community 15`, `Community 20`, `Community 21`, `Community 27`, `Community 28`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `Candidate` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `Question` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`?**
